<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mb-6">Añadir Nuevo Dispositivo</h1>
                ...
                <form action="{{ route('dispositivos.store') }}" method="POST">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" name="tipo_sensor" id="tipo_sensor" class="border border-gray-300 rounded p-2 w-full" required>
                    </div>

                    <div class="form-group mb-4">
                        <label for="estado" class="block text-gray-700 font-bold mb-2">Estado</label>
                        <input type="text" name="estado" id="estado" class="border border-gray-300 rounded p-2 w-full" required>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select name="id_estacion" id="id_estacion" class="border border-gray-300 rounded p-2 w-full" required>
                            <option value="" disabled selected>Seleccionar una estación</option>
                            @foreach($estaciones as $estacion)
                                <option value="{{ $estacion->id_estacion }}">{{ $estacion->nombre_estacion }}</option>
                            @endforeach
                        </select>
                    </div>
